...
public class Customer implements Serializable {
    ...
    @NotEmpty(message = "The customer email can not be empty")
    private String customerEmail;
    private String customerPhone;

    @NotEmpty(message = "the customer username can not be empty")
    private String username;

    @NotEmpty(message = "The customer password can not be empty")
